...
const secureBooking = function () {
  ...
  return function () {
    passengerCounter++;
    console.log(`${passengerCounter} passenger`);
  };
};
...
that changes the color of the selected h1 element ('header') to blue, each time the BODY
...
time you need. Think about WHEN exactly the callback function is executed, and what
